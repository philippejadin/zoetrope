...
int flash_duration = 1500; // motion blur : 1000 : nickel, 1500 plus lumineux, jusque 5500 (ultra blanc)
...
void loop() 
{
  ...
  //motor_interval = constrain(motor_interval, motor_interval_min, motor_interval_max);
    ...
    //if (1)
  {
    ...
    //Serial.println(additional_delay);
  ...
  if (additional_delay > 0)
     {
     delayMicroseconds(additional_delay);
     }
     */
